...
class BaiPiaoNode(Node):
    ...
    def borrow_money_eat(self):
        ...
        self.borrow_money_client_.call_async(request).add_done_callback(self.borrow_money_eat_callback)    

    def borrow_money_eat_callback(self,response):
        """
        借钱结果回调
        """
