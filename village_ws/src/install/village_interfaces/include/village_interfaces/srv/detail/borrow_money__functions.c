  ...
  village_interfaces__srv__BorrowMoney_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    village_interfaces__srv__BorrowMoney_Request * data =
      (village_interfaces__srv__BorrowMoney_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!village_interfaces__srv__BorrowMoney_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          village_interfaces__srv__BorrowMoney_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  village_interfaces__srv__BorrowMoney_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    village_interfaces__srv__BorrowMoney_Response * data =
      (village_interfaces__srv__BorrowMoney_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!village_interfaces__srv__BorrowMoney_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          village_interfaces__srv__BorrowMoney_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
