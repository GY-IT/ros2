  ...
  cartographer_ros_msgs__srv__SubmapQuery_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    cartographer_ros_msgs__srv__SubmapQuery_Request * data =
      (cartographer_ros_msgs__srv__SubmapQuery_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cartographer_ros_msgs__srv__SubmapQuery_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          cartographer_ros_msgs__srv__SubmapQuery_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  cartographer_ros_msgs__srv__SubmapQuery_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    cartographer_ros_msgs__srv__SubmapQuery_Response * data =
      (cartographer_ros_msgs__srv__SubmapQuery_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cartographer_ros_msgs__srv__SubmapQuery_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          cartographer_ros_msgs__srv__SubmapQuery_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
