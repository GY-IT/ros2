...
static size_t _GetTrajectoryStates_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_cartographer_ros_msgs__srv__GetTrajectoryStates_Request(
    full_bounded, 0);
}
...
static size_t _GetTrajectoryStates_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_cartographer_ros_msgs__srv__GetTrajectoryStates_Response(
    full_bounded, 0);
}
