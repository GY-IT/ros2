...
{
  cartographer_ros_msgs__msg__MetricFamily * msg = (cartographer_ros_msgs__msg__MetricFamily *)malloc(sizeof(cartographer_ros_msgs__msg__MetricFamily));
  if (!msg) {
    return NULL;
  }
...
cartographer_ros_msgs__msg__MetricFamily__Sequence__init(cartographer_ros_msgs__msg__MetricFamily__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (cartographer_ros_msgs__msg__MetricFamily *)calloc(size, sizeof(cartographer_ros_msgs__msg__MetricFamily));
    if (!data) {
      return false;
    }
...
{
  cartographer_ros_msgs__msg__MetricFamily__Sequence * array = (cartographer_ros_msgs__msg__MetricFamily__Sequence *)malloc(sizeof(cartographer_ros_msgs__msg__MetricFamily__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  cartographer_ros_msgs__msg__MetricFamily__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    cartographer_ros_msgs__msg__MetricFamily * data =
      (cartographer_ros_msgs__msg__MetricFamily *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cartographer_ros_msgs__msg__MetricFamily__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          cartographer_ros_msgs__msg__MetricFamily__fini(&data[i]);
        }
        free(data);
        return false;
      }
