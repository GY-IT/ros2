...
{
  cartographer_ros_msgs__msg__HistogramBucket * msg = (cartographer_ros_msgs__msg__HistogramBucket *)malloc(sizeof(cartographer_ros_msgs__msg__HistogramBucket));
  if (!msg) {
    return NULL;
  }
...
cartographer_ros_msgs__msg__HistogramBucket__Sequence__init(cartographer_ros_msgs__msg__HistogramBucket__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (cartographer_ros_msgs__msg__HistogramBucket *)calloc(size, sizeof(cartographer_ros_msgs__msg__HistogramBucket));
    if (!data) {
      return false;
    }
...
{
  cartographer_ros_msgs__msg__HistogramBucket__Sequence * array = (cartographer_ros_msgs__msg__HistogramBucket__Sequence *)malloc(sizeof(cartographer_ros_msgs__msg__HistogramBucket__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  cartographer_ros_msgs__msg__HistogramBucket__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    cartographer_ros_msgs__msg__HistogramBucket * data =
      (cartographer_ros_msgs__msg__HistogramBucket *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cartographer_ros_msgs__msg__HistogramBucket__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          cartographer_ros_msgs__msg__HistogramBucket__fini(&data[i]);
        }
        free(data);
        return false;
      }
