...
{
  cartographer_ros_msgs__msg__Metric * msg = (cartographer_ros_msgs__msg__Metric *)malloc(sizeof(cartographer_ros_msgs__msg__Metric));
  if (!msg) {
    return NULL;
  }
...
cartographer_ros_msgs__msg__Metric__Sequence__init(cartographer_ros_msgs__msg__Metric__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (cartographer_ros_msgs__msg__Metric *)calloc(size, sizeof(cartographer_ros_msgs__msg__Metric));
    if (!data) {
      return false;
    }
...
{
  cartographer_ros_msgs__msg__Metric__Sequence * array = (cartographer_ros_msgs__msg__Metric__Sequence *)malloc(sizeof(cartographer_ros_msgs__msg__Metric__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  cartographer_ros_msgs__msg__Metric__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    cartographer_ros_msgs__msg__Metric * data =
      (cartographer_ros_msgs__msg__Metric *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cartographer_ros_msgs__msg__Metric__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          cartographer_ros_msgs__msg__Metric__fini(&data[i]);
        }
        free(data);
        return false;
      }
