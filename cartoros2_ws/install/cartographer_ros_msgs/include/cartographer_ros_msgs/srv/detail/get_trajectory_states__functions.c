...
{
  cartographer_ros_msgs__srv__GetTrajectoryStates_Request * msg = (cartographer_ros_msgs__srv__GetTrajectoryStates_Request *)malloc(sizeof(cartographer_ros_msgs__srv__GetTrajectoryStates_Request));
  if (!msg) {
    return NULL;
  }
...
cartographer_ros_msgs__srv__GetTrajectoryStates_Request__Sequence__init(cartographer_ros_msgs__srv__GetTrajectoryStates_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (cartographer_ros_msgs__srv__GetTrajectoryStates_Request *)calloc(size, sizeof(cartographer_ros_msgs__srv__GetTrajectoryStates_Request));
    if (!data) {
      return false;
    }
...
{
  cartographer_ros_msgs__srv__GetTrajectoryStates_Request__Sequence * array = (cartographer_ros_msgs__srv__GetTrajectoryStates_Request__Sequence *)malloc(sizeof(cartographer_ros_msgs__srv__GetTrajectoryStates_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  cartographer_ros_msgs__srv__GetTrajectoryStates_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    cartographer_ros_msgs__srv__GetTrajectoryStates_Request * data =
      (cartographer_ros_msgs__srv__GetTrajectoryStates_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cartographer_ros_msgs__srv__GetTrajectoryStates_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          cartographer_ros_msgs__srv__GetTrajectoryStates_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  cartographer_ros_msgs__srv__GetTrajectoryStates_Response * msg = (cartographer_ros_msgs__srv__GetTrajectoryStates_Response *)malloc(sizeof(cartographer_ros_msgs__srv__GetTrajectoryStates_Response));
  if (!msg) {
    return NULL;
  }
...
cartographer_ros_msgs__srv__GetTrajectoryStates_Response__Sequence__init(cartographer_ros_msgs__srv__GetTrajectoryStates_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (cartographer_ros_msgs__srv__GetTrajectoryStates_Response *)calloc(size, sizeof(cartographer_ros_msgs__srv__GetTrajectoryStates_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  cartographer_ros_msgs__srv__GetTrajectoryStates_Response__Sequence * array = (cartographer_ros_msgs__srv__GetTrajectoryStates_Response__Sequence *)malloc(sizeof(cartographer_ros_msgs__srv__GetTrajectoryStates_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  cartographer_ros_msgs__srv__GetTrajectoryStates_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    cartographer_ros_msgs__srv__GetTrajectoryStates_Response * data =
      (cartographer_ros_msgs__srv__GetTrajectoryStates_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cartographer_ros_msgs__srv__GetTrajectoryStates_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          cartographer_ros_msgs__srv__GetTrajectoryStates_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
